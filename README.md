...
I'm a **B.Tech (ECE) student** who enjoys working at the intersection of  
**Deep Learning**, **Systems Programming**, and **Web Development**.
...
### **Commute** 🚦
*A traffic flow prediction system using spatio-temporal modeling*

- **Model:** Spatio-Temporal Graph Neural Network  
- **Architecture:**  
  - Graph Attention Networks (GAT) for spatial dependencies  
  - Mamba (State Space Models) for temporal modeling  
- **Goal:** Accurate traffic forecasting by capturing complex spatial + temporal patterns  
...
![Reinforcement Learning](https://img.shields.io/badge/Reinforcement_Learning-3A3A3A?style=for-the-badge)
...
- GANs
- VAEs
- Reinforcement Learning with VAEs

#### Training & Systems Awareness
...
![HTTP](https://img.shields.io/badge/HTTP_&_Networking-005571?style=for-the-badge)
...
- Basic Network Debugging & Analysis
...
#### Networking Foundations (Security-Oriented)
- OSI & TCP/IP Models
- TCP vs UDP (handshakes, ports, states)
- HTTP vs HTTPS
- DNS resolution & attacks
- Client–Server Communication
- Network Ports & Services
- Packet Flow & Latency Analysis
...
- Protocol Analysis (HTTP, TCP, DNS)
...
![John_the_Ripper](https://img.shields.io/badge/John_the_Ripper-000000?style=for-the-badge)
